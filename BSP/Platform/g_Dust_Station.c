...
// const uint8_t Inqure_AirPressure[CMDLength]={0x06,0x03,0x00,0x00,0x00,0x01,0x85,0xBD};        //气压
// const uint8_t Inqure_Illumination[CMDLength]={0x07,0x03,0x00,0x00,0x00,0x02,0xC4,0x6D};       //光照
// const uint8_t Inqure_RainGauge[CMDLength]={0x08,0x03,0x00,0x00,0x00,0x01,0x84,0x93};          //雨量-XPH
// const uint8_t Inqure_Radiation[CMDLength]={0x09,0x03,0x00,0x00,0x00,0x01,0x85,0x42};          //总辐射-太阳辐射
// const uint8_t Inqure_HCD6816_YS[CMDLength]={0xFF,0x03,0x00,0x03,0x00,0x0C,0xA0,0x11};         //气象六要素传感器--YS
